...
import msgSetPng from '@/assets/images/msg-set.png';
import msgHeaderPng from '@/assets/images/msg-header.png';
import isAnswerPng from '@/assets/images/is-answer.png';
    ...
    return (
      <ScrollView className="message-scroll-view" scrollY="true" onScroll={this.onScroll}>
        <View className="message-bar">
          ...
          <Image className="message-bar-icon" src={msgSetPng} />
        </View>
